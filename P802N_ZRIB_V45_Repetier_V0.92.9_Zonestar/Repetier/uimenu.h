...
// **** Positionening menu
UI_MENU_ACTIONCOMMAND_FILTER_T(ui_menu_home_all, UI_TEXT_HOME_ALL_ID, UI_ACTION_HOME_ALL, 0, MENU_MODE_PRINTING2)
UI_MENU_ACTIONCOMMAND_FILTER_T(ui_menu_home_x, UI_TEXT_HOME_X_ID, UI_ACTION_HOME_X, 0, MENU_MODE_PRINTING2)
UI_MENU_ACTIONCOMMAND_FILTER_T(ui_menu_home_y, UI_TEXT_HOME_Y_ID, UI_ACTION_HOME_Y, 0, MENU_MODE_PRINTING2)
UI_MENU_ACTIONCOMMAND_FILTER_T(ui_menu_home_z, UI_TEXT_HOME_Z_ID, UI_ACTION_HOME_Z, 0, MENU_MODE_PRINTING2)
...
UI_MENU_ACTIONCOMMAND_FILTER_T(ui_menu_quick_stopstepper, UI_TEXT_DISABLE_STEPPER_ID, UI_ACTION_DISABLE_STEPPER, 0, MENU_MODE_PRINTING2)
...
#ifdef FIRST_TEST_ENABLE
UI_MENU_ACTIONCOMMAND(ui_menu_debug_firsttest,UI_TEXT_FIRST_TEST,UI_ACTION_FIRST_TEST);
#define UI_MENU_FIRST_TEST &ui_menu_debug_firsttest,
#define UI_MENU_FIRST_TETS_CNT 1
#else
#define UI_MENU_FIRST_TEST
#define UI_MENU_FIRST_TETS_CNT 0
#endif

#define UI_MENU_DEBUGGING {UI_MENU_ADDCONDBACK UI_MENU_FIRST_TEST &ui_menu_debug_echo,&ui_menu_debug_info,&ui_menu_debug_error,&ui_menu_debug_dryrun,&ui_menu_debug_endstop}
UI_MENU(ui_menu_debugging, UI_MENU_DEBUGGING, 5 + UI_MENU_BACKCNT + UI_MENU_FIRST_TETS_CNT)
...
UI_MENU_ACTIONCOMMAND(ui_menu_autolevel_measure, UI_TEXT_AUTOLEVEL_MEASURE, UI_ACTION_AUTOLEVEL_MEASURE)
#define UI_TOOGLE_AUTOLEVEL_ENTRY ,&ui_menu_toggle_autolevel
#define UI_AUTOLEVEL_MEASURE_ENTRY ,&ui_menu_autolevel_measure
#define UI_TOGGLE_AUTOLEVEL_COUNT 2
#else
#define UI_TOOGLE_AUTOLEVEL_ENTRY
#define UI_AUTOLEVEL_MEASURE_ENTRY
#define UI_TOGGLE_AUTOLEVEL_COUNT 0
#endif
#define UI_MENU_GENERAL {UI_MENU_ADDCONDBACK &ui_menu_general_baud,&ui_menu_general_stepper_inactive,&ui_menu_general_max_inactive UI_TOOGLE_AUTOLEVEL_ENTRY UI_AUTOLEVEL_MEASURE_ENTRY}
