...
FSTRINGVAR(tZAutolevleMeasureScript)
...
FSTRINGVAR(tFirttestScript_0)
FSTRINGVAR(tFirttestScript_00)
FSTRINGVAR(tFirttestScript_1)
FSTRINGVAR(tFirttestScript_2)
FSTRINGVAR(tFirttestScript_3)
FSTRINGVAR(tFirttestScript_4)
FSTRINGVAR(tFirttestScript_5)
FSTRINGVAR(tFirttestScript_6)
FSTRINGVAR(tFirttestScript_7)
FSTRINGVAR(tFirttestScript_8)
FSTRINGVAR(tFirttestScript_9)
FSTRINGVAR(tFirttestScript_10)
FSTRINGVAR(tFirttestScript_11)
FSTRINGVAR(tFirttestScript_12)
FSTRINGVAR(tFirttestScript_13)
FSTRINGVAR(tFirttestScript_14)
#endif
