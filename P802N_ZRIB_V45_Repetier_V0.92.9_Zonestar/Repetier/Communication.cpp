...
FSTRINGVALUE(Com::tZAutolevleMeasureScript,Z_AUTOLEVEL_MEASURE_SCRIPT)
#endif
...
FSTRINGVALUE(Com::tFirttestScript_0,"G4 S1\n")
FSTRINGVALUE(Com::tFirttestScript_00,"G4 S3\n")
FSTRINGVALUE(Com::tFirttestScript_1,"G91\n")
FSTRINGVALUE(Com::tFirttestScript_2,"M444\n")
FSTRINGVALUE(Com::tFirttestScript_3,"G1 X-50 F2000\n")
FSTRINGVALUE(Com::tFirttestScript_4,"G1 X50 F2000\n")
FSTRINGVALUE(Com::tFirttestScript_5,"G1 Y-50 F2000\n")
FSTRINGVALUE(Com::tFirttestScript_6,"G1 Y50 F2000\n")
FSTRINGVALUE(Com::tFirttestScript_7,"G1 Z5 F200\n")
FSTRINGVALUE(Com::tFirttestScript_8,"G1 Z-5 F200\n")
FSTRINGVALUE(Com::tFirttestScript_9,"M106 S100\n")
FSTRINGVALUE(Com::tFirttestScript_10,"M107\n")
FSTRINGVALUE(Com::tFirttestScript_11,"M190 S40\n")
FSTRINGVALUE(Com::tFirttestScript_12,"M109 S200\n")
FSTRINGVALUE(Com::tFirttestScript_13,"G1 E8 F200\n")
FSTRINGVALUE(Com::tFirttestScript_14,"G1 E-3 F200\n")
#endif
